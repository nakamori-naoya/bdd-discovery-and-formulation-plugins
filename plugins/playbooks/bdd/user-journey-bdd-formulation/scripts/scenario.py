...
def main():
    ...
    requirements = playbook.get("requirements", {})
    if playbook.get("focus") != "user-journey" or not requirements.get("multiple_meaningful_scenes"):
        fail("ユーザー目的達成BDD用の解決済み設定ではない")
    try:
