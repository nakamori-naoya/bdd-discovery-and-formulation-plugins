...
- ハーネスが作る資料の冒頭は読み手の既知の語で書いた本文段落から始め、メタ情報の一覧を置かない。中心の問い、扱う理由、役割×目的の一覧、除外事項の送り先のような作業記録は報告に載せ、正式な定義へ写さない。
