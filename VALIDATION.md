...
`validate-structure.sh`は、BDD責務の10 pluginだけを配布すること、両marketplaceと両runtime manifestのidentityが一致すること、外部依存がmarketplace名とplugin名だけで宣言されていること、shared resolverの配布コピーがbyte一致することを検査する。
